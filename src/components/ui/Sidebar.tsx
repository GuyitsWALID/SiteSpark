    ...
    <div className={`bg-white border-r border-gray-200 transition-all duration-300 ${isCollapsed ? 'w-16' : 'w-64'} flex flex-col`}>
      ...
      <div className="p-4 border-b border-gray-200">
        <Link href="/" className="flex items-center space-x-3">
          ...
          {!isCollapsed && (
            <div>
              <span className="text-lg font-bold text-gray-900">SiteSpark</span>
              <p className="text-xs text-gray-500">Mini Websites</p>
            </div>
          )}
        </Link>
      </div>
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4">
            ...
            <Link
              ...
              className="w-full block text-center py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors"
            >
              Upgrade Now
            </Link>
          </div>
